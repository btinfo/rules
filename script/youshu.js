/* https://raw.githubusercontent.com/yqc007/QuantumultX/master/CellularBookProCrack.js

有书解锁会员精读&付费精选

[Script]
有书 = type=http-response,requires-body=1,pattern=^https?:\/\/(sc|gongdu)\.youshu\.cc\/(m|w|mp)\/(user\/count|media\/media_info|common\/elite_page_content|(page\/v2\/10010016|item\/subpage_pack_list).+)$,script-path=Script/youshu.js
