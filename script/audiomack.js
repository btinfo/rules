...
Audiomack Premium 一次性解锁
https://apps.apple.com/cn/app/id921765888

[Script]
Audiomack = type=http-response,requires-body=1,pattern=^https?:\/\/api\.revenuecat\.com\/v1\/subscribers\/(identify|\d+)$,script-path=Script/audiomack.js,enable=false

[MITM]
hostname = api.revenuecat.com
pattern = https://api.revenuecat.com/v1/subscribers
